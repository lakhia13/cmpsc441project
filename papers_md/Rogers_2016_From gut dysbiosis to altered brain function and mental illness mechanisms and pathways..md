# Rogers_2016_From gut dysbiosis to altered brain function and mental illness mechanisms and pathways.
...
The human body hosts an enormous abundance and diversity of microbes, which perform a range of essential and beneﬁcial
...
also inﬂuence neural development, cognition and behaviour, with recent evidence that changes in behaviour alter gut microbiota
composition, while modiﬁcations of the microbiome can induce depressive-like behaviours. Although an association between
...
exciting ﬁeld of research can inform care and provide a basis for the design of novel, microbiota-targeted, therapies.
...
also been attempts to inﬂuence the composition of the gut
microbiota to achieve clinical beneﬁt. For example,
in the ﬁrst
...
in the 1920s because of a lack of mechanistic
from favour
...
microbiota with speciﬁc psychiatric disorders. We examine the
...
discuss the potential for modiﬁcation of the gut microbiome to
provide clinical beneﬁt in the context of altered brain function.
...
emotional centres of
It encompasses the central,
...
that the microbiome has a key role in inﬂuencing the develop-
ment and function of the nervous system through its interaction
with the gut–brain axis,
it has been suggested that a ‘micro-
...
important determinant of gut microbiota
...
in mice,32 while altered microbial diversity upon
behaviour
consumption of a diet high in sucrose results in signiﬁcantly
...
exposed microbiota showed signiﬁcant and selective disruptions
...
on brain function, such ﬁndings do suggest that diet-induced
changes in the intestinal microbiome substantially inﬂuence brain
function.

Diet and antibiotic exposure are only two factors

that
potentially inﬂuence brain function through shaping the gut
...
how wider inﬂuences on the microbiome contribute to dysregula-
tion of brain function is an area of growing interest.

THE MICROBIOME IN SPECIFIC PSYCHIATRIC CONDITIONS
While the links between the microbiome and speciﬁc psychiatric
...
Major depressive disorder (MDD) is typiﬁed by markers known
to be inﬂuenced by the microbiome. For example, depression-
associated changes seen in the hypothalamic-pituitary-adrenal
response,46 and altered levels of depression-
(HPA)
associated monoamines (or
in corticolimbic
their
regions of the brain, have both been demonstrated in germ-free
(GF) mice.28,47–50
of pro-
inﬂammatory cytokines seen in MDD46 may also result from
...
associated with increased gut permeability and bacterial
...
Figure 1. Communication pathways linking the gut microbiome
with brain function.
...
between depressive states and dysbiosis. A reﬂection of the
...
et al.44). Many of the strongest associations identiﬁed between
involved
genetic
risk and schizophrenia relate to genes
in immunity,57,58 paralleling clinical
report an
upregulated immune and inﬂammatory status in schizophrenia
...
niﬁcantly correlated with systemic inﬂammatory markers.69 In
turn, cytokine levels are correlated with the severity of
clinical symptoms,59,70,71 and it has been suggested that the
resulting neuroinﬂammation is involved directly in schizophrenia
pathogenesis.72–74
...
underlying altered cognition,76 and through its inﬂuence on brain
...
MENTAL ILLNESS
In addition to inﬂuencing psychopathogenesis directly, the gut
microbiome makes an important contribution to drug metabo-
the inter-individual
lism, and potentially explains much of
...
variability in treatment efﬁcacy and side-effects.78,79 For example,
the gut microbiota has been implicated in the reductive
...
gut microbiome is also able to inﬂuence the gene expression of
hepatic enzymes that aid in the metabolism and detoxiﬁcation of
...
the gut microbiome.
For example,
the atypical antipsychotic olazapine has been
shown to affect microbiota composition in rats, as well as
triggering inﬂammatory effects and weight gain,85,86 with the
co-administration of antibiotics
shown to attenuate these
...
signiﬁcant
insults that occur during gestation is
...
ing anxiety, autism, attention deﬁcit hyperactivity disorder,
...
psychopathologies, remain poorly deﬁned. To a large extent, this
...
systems. Even in animal models, it is extremely difﬁcult to identify
...
shown to inﬂuence multiple regulatory pathways
in the
immune,112,113 metabolic114 and neuroendocrine110
systems,
...
to aberrant neurodevelopment
appears to be the disruption of the immuno-regulatory role of
the gut microbiome, resulting in a pro-inﬂammatory maternal
...
normal microbiota, such as antibiotics,
thereby suppressing
...
microbiome can inﬂuence these pathways remains unknown.

The manner

in which a hyperactive maternal HPA stress
response inﬂuences fetal development is unclear; however, an
emerging hypothesis involves maternal cortisol crossing the
placenta in a quantity sufﬁcient to affect gene expression in fetal
brain cells.143 This model
is supported by in vitro analysis of
...
to affecting fetal neurodevelopment directly,
stress-induced
alterations to the HPA axis trigger maternal gut dysbiosis.146
These changes in the gut microbiota could further inﬂuence HPA
axis dysfunction through altered tryptophan metabolism, as well
as contributing to other dysbiosis-associated dysregulatory
pathways.94 In addition, there is evidence that the gut microbiome
inﬂuences the function of the placenta via the HPA axis, thereby
altering fetal exposure to speciﬁc compounds in maternal
circulation.147–150

The maternal gut microbiota could also affect fetal neurodeve-
lopment by inﬂuencing levels of circulating 5-hydroxytryptamine
(5-HT). The gut microbiome regulates 5-HT biosynthesis by
enterochromafﬁn (EC) cells in the gut.13 In turn, 5-HT regulates
fetal neuronal cell division, differentiation and synaptogenesis151
in altered brain development.152
and its depletion results
Furthermore, maternal plasma serotonin is required for proper
neuronal morphogenesis during developmental
that
...
likely to inﬂuence blood–brain barrier (BBB) formation, a critical
component in CNS development, ensuring an optimal micro-
environment for neuronal growth and speciﬁcation.154 This is
...
Neurodevelopment continues outside the womb with the
...
before a process of synaptic reﬁnement and elimination reduces
the number of synapses in the postnatal brain to adult levels by
mid-adolescence.158 Remodelling continues well
into the third
...
immune function,160–164 the neuroendocrine system165
normal
and metabolic regulation.166,167 Disruption of the microbiome in
early life therefore has the potential to inﬂuence neurodevelop-
...
and reduced BDNF expression levels
in the cortex and
...
development. However, while a useful
for highlighting
mechanistic pathways, the GF animal poorly reﬂects the types of
...
which a direct causal relationship exists is difﬁcult to discern, given
...
microbiome and increased anxiety, social deﬁcits and repetitive
...
transmission of microbiota, the inﬂuence of the maternal micro-
...
the composition of the human infant gut microbiota over the ﬁrst
...
and visceral hypersensitivity.186 Further,
the developmental
...
disruption of physical and sensory-motor maturation, and
...
Activation of inﬂammatory pathways appears to be a particularly
...
triggering bidirectional communication with the CNS.192
In
addition,
indirect effects of the gut microbiota on the innate
immune system can result in alterations in the circulating levels of
pro- and anti-inﬂammatory cytokines that directly affect brain
function.
...
Bacterial metabolites from the gut have a substantial
...
proportions and an immature phenotype,
leading to impaired
...
signal
this source of 5-HT has
signiﬁcant links to psychiatric disorders with the most commonly
used antidepressant, ﬂuoxetine, blocking the transport of gut 5-HT
...
brain function by inﬂuencing tryptophan metabolism (reviewed
...
The availability of tryptophan is heavily inﬂuenced by the gut
...
serotonin (reviewed by O’Mahony and
of
colleagues95), while the microbiota might also affect tryptophan
availability by inﬂuencing host enzymes responsible for
its
degradation.47 By limiting the availability of
tryptophan for
serotonin production in the CNS (EC-derived serotonin does not
cross the BBB), the gut microbiota could inﬂuence serotonergic
neurotransmission.95 In vulnerable populations,
reducing the
...
inhibitors.232,233 The gut microbiota could also inﬂuence the
production of both neuroprotective and neurotoxic components
of the kynurenine pathway.224

Other pathways by which the gut microbiota could inﬂuence
...
of caspase 1 leading to decreased inﬂammasome function, or
pharmacological treatments result in changes in the gut micro-
biome. The paper by Zheng et al. shows three key ﬁndings: (i) the
absence of gut microbiota in GF mice resulted in decreased
immobility time in the forced swimming test
relative to
(ii) From clinical
conventionally-raised healthy control mice.
sampling, the gut microbiotic compositions of MDD patients
and healthy controls were signiﬁcantly different from that of MDD
...
‘healthy microbiota’ derived from healthy control
individuals.
Moreover, the concerned authors showed that mice harbouring
‘depression microbiota’ primarily exhibited disturbances of
...
metabolism.235 The combined ﬁndings of
these two papers
...
DECLINE
inﬂuences, the gut
Despite ﬂuctuating in response to external
microbiota is
...
appears to have a substantial inﬂuence on CNS degeneration in
...
Proteobacteria and a reduction in biﬁdobacteria species, and
...
inﬂammatory stimulation,

the processes of age-related
dysbiosis and neurological decline are linked through the former
mediating chronic low-grade inﬂammation as a common basis for
a broad spectrum of age-related pathologies, or
so-called
‘inﬂamm-aging’.242 Inﬂammation has a substantial role in cogni-
...
this process,
the
production of pro-inﬂammatory metabolites, and the loss of
...
Caraccciolo et al.239). Notably, dysbiosis-associated inﬂammation is
...
tially implicating microbiome-inﬂuenced changes in tryptophan
...
in the elderly, as well as disorders such as diabetes,
faecal
incontinence and cardiovascular diseases.94,250

An association between loss of microbiome function, speciﬁ-
cally genes that encode SCFAs, and increased levels of circulating
pro-inﬂammatory cytokines, has been shown in healthy elderly
people.251 Further, markers of microbiome change are signiﬁ-
...
and cognitive function.252 Interestingly,
in mice, the same HFD
predisposes to physiological and anxiety-like effects in adults,
while aged mice display deﬁcits in spatial cognition,253 suggesting
...
standing of how the bidirectional
inﬂuences age-related
...
on the speciﬁc role of the microbiome in pathogenesis.
...
in rats deprived of
may be clinically effective. For example,
maternal contact at an early age, treatment with Biﬁdobacterium
infantis results in normalization of the immune response, reversal
of behavioural deﬁcits, and restoration of basal noradrenaline
concentrations in the brainstem,257 while in a mouse model of
gastrointestinal inﬂammation and infection, exposure to B. longum
...
ments.260,261 Such effects are not limited to rodent models;
in
...
the vagus nerve22,191,258 or
changes through stimulation of
...
inﬂuence brain activity.264,265 Here,
it may be the absence of
suitable drivers of beneﬁcial behaviour that is limiting, rather than
the absence of microbes capable of exhibiting them.
In such
...
fructooligosaccharides or a non-
...
interleukin-1β and
to be related to the modulation of cortical
5-HT2A receptor expression.267 In humans, daily consumption of
BGOS for 3 weeks results in a signiﬁcantly lower salivary cortisol
...
attenuation of
the corticosterone response to acute stress.
Interestingly, while the supporting evidence for the efﬁcacy or
such approaches is only now emerging, the consumption of
wholegrain and high ﬁbre foods, essentially prebiotics, is already
...
treatment of conditions such as recurrent Clostridium difﬁcile
infection.271 Its ability to inﬂuence behaviour suggests that it
...
that underpin altered brain development and mental
illness is
...
investments made to ‘microbiome–
reﬂected in the substantial
...
our resident microbiota. Reﬁning these models based on empirical
...
5 Kennedy PJ, Cryan JF, Dinan TG, Clarke G.

microbiome-gut-brain axis disorder? World J Gastroenterol
14105–14125.
...
11 Foster JA, McVey Neufeld KA. Gut-brain axis: how the microbiome inﬂuences
...
microbiome contributes to a substantial proportion of
...
16 Valentini M, Piermattei A, Di Sante G, Migliara G, Delogu G, Ria F.
...
central nervous system in normal gastrointestinal
Gastroenterology 2009; 136: 2003–2014.

21 Rhee SH, Pothoulakis C, Mayer EA. Principles and clinical
...
ﬂexibility. Neuroscience 2015; 300: 128–140.

34 Kaptan Z, Akgün-Dar K, Kapucu A, Dedeakayoğulları H, Batu Ş, Üzüm G. Long
low-calorie diet during
term consequences on spatial
...
targeting microbiota in major psychiatric disorders: a

"psychomicrobiotic":
systematic review. Pathol Biol (Paris) 2015; 63: 35–42.

43 Castro-Nallar E, Bendall ML, Pérez-Losada M, Sabuncyan S, Severance EG,
Dickerson FB et al. Composition,
taxonomy and functional diversity of
...
negative enterobacteria (leaky gut) plays a role in the inﬂammatory patho-
...
colonic function and microbiota proﬁle in a mouse model of chronic depression.
...
59 Fan X, Goff DC, Henderson DC.
Neurother 2007; 7: 789–796.

Inﬂammation and schizophrenia. Expert Rev

60 Song X, Fan X, Song X, Zhang J, Zhang W, Li X et al. Elevated levels of adipo-
nectin and other cytokines in drug naïve, ﬁrst episode schizophrenia patients
...
63 Müller N, Myint AM, Schwarz MJ. Inﬂammation in schizophrenia. Adv Protein

Chem Struct Biol 2012; 88: 49–68.

64 Potvin S, Stip E, Sepehry AA, Gendron A, Bah R, Kouassi E. Inﬂammatory cytokine
...
NJ et al. An activated set point of T-cell and monocyte inﬂammatory networks in
recent-onset schizophrenia patients involves both pro- and anti-inﬂammatory
...
IL-10 and TNF-α in patients with bipolar disorder and schizo-
levels of IL-6,
phrenia: differences in pro- and anti-inﬂammatory balance. Rev Bras Psiquiatr
2011; 33: 268–274.

68 Pedrini M, Massuda R, Fries GR, de Bittencourt Pasquali MA, Schnorr CE, Moreira
JC et al. Similarities in serum oxidative stress markers and inﬂammatory cyto-
...
72 Na KS, Jung HY, Kim YK. The role of pro-inﬂammatory cytokines in the neu-
roinﬂammation and neurogenesis of schizophrenia. Prog Neuropsychopharmacol
...
inﬂammation and associated immune activation in schizo-
...
79 Zhang JP, Malhotra AK. Pharmacogenetics and antipsychotics: therapeutic efﬁ-
cacy and side effects prediction. Expert Opin Drug Metab Toxicol 2011; 7: 9–37.
80 Elmer GW, Remmel RP. Role of the intestinal microﬂora in clonazepam meta-
...
patients with PD and motor ﬂuctuations. Neurology 2007; 68: 1085.
...
on body weight, inﬂammatory, metabolic and microbiota parameters. Psycho-
...
neuropsychiatric ﬁeld. Int Rev Neurobiol 2011; 101: 329–349.
...
99 Brown AS, Susser ES. Prenatal nutritional deﬁciency and risk of adult schizo-
...
Irrsack E, Osorio C, Koch M. Prenatal LPS-exposure--a neuro-
rat model of schizophrenia--differentially affects cognitive
developmental
...
103 Finegold SM. State of the art; microbiology in health and disease.

Intestinal

bacterial ﬂora in autism. Anaerobe 2011; 17: 367–368.
...
learning, cortical plasticity and hippocampal anatomy in a neuro-
spatial
...
107 Marques AH, O'Connor TG, Roth C, Susser E, Bjørke-Monsen AL. The inﬂuence of
...
the neuroendocrine system and behavior. Horm Behav 2015; 76:
...
113 Verwaerde C, Delanoye A, Macia L, Tailleux A, Wolowczuk I. Inﬂuence of high-fat
immune response in

feeding on both naive and antigen-experienced T-cell
...
inﬂammation-related genes. Br J Nutr 2015; 113: 867–877.
...
116 Khandaker GM, Zimbron J, Lewis G, Jones PB. Prenatal maternal
...
relationship and mechanisms. Curr Psychiatry Rep 2015;
...
acetylcholine receptor alpha7 subunit is an essential regulator of inﬂammation.
Nature 2003; 421: 384–388.

127 de Lartigue G, de La Serre CB, Raybould HE. Vagal afferent neurons in high fat
diet-induced obesity; intestinal microﬂora, gut inﬂammation and cholecystoki-
...
is moderated by maternal anxiety. Psychoneur-

amniotic ﬂuid cortisol
...
learning deﬁcits in the adult rat: a possible model of neurodevelopmental
disorders with cognitive deﬁcits. Brain Res 1997; 760: 68–73.
...
effects of neonatal hypoxia on development of brain and heart? Inﬂuence of
...
microbiota inﬂuences blood-brain barrier permeability in mice. Sci Transl Med
2014; 6: 263ra158.
...
ment in the ﬁrst year. Neuropediatrics 1997; 28: 296–306.
...
systemic neutrophilic inﬂammatory response. Immunology 2013; 140: 483–492.
161 Abt MC, Osborne LC, Monticelli LA, Doering TA, Alenghat T, Sonnenberg GF et al.
innate antiviral

Commensal bacteria calibrate the activation threshold of
...
Commensal microbiota is fundamental for the development of inﬂammatory
...
behavior, cognition, and neuroinﬂammation in adolescent rats: relevance to
...
intestinal microbiota inﬂuence the devel-

nutritional modulation of maternal
opment of the infant gastrointestinal tract? J Nutr 2012; 142: 1921–1928.

178 Tannock GW, Savage DC.

Inﬂuences of dietary and environmental stress on
...
microbiota during the ﬁrst year of life: a prospective cohort study. BJOG; doi:
10.1111/1471-0528.13601; e-pub ahead of print.

184 Tanaka S, Kobayashi T, Songjinda P, Tateyama A, Tsubouchi M, Kiyohara C
et al. Inﬂuence of antibiotic exposure in the early postnatal period on the devel-
...
nerve stimulation attenuates the systemic inﬂammatory response to endotoxin.
...
192 Dantzer R. Cytokine, sickness behavior, and depression.
...
microbiota reduces leptin sensitivity and the expression of
the obesity-
...
is there a role for enterochromafﬁn cells? Am J Physiol Gastrointest Liver Physiol
2011; 301: G519–G527.
...
children and their ﬁrst-degree relatives: relationships between serotonin and nor-
...
and their ﬁrst-degree relatives. Biol Psychiatry 1999; 45: 158–163.
...
Inserra A, Lewis MD, Mastronardi CA, Kentish S, Leong L et al.
Inﬂammasome signaling affects anxiety- and depressive-like behavior and gut
...
beyond: gut microbiota and inﬂammatory status in seniors and centenarians.
...
Inﬂamm-aging. An evolutionary perspective on immunosenescence. Ann N Y
Acad Sci 2000; 908: 244–254.

243 Grifﬁn WS. Neuroinﬂammatory cytokine signaling and Alzheimer's disease. N
...
probiotic Biﬁdobacterium infantis in the maternal separation model of depres-
sion. Neuroscience 2010; 170: 1179–1188.

258 Bercik P, Verdu EF, Foster JA, Macri J, Potter M, Huang X et al. Chronic gastro-
intestinal inﬂammation induces anxiety-like behavior and alters central nervous
...
of Biﬁdobacterium longum NCC3001 involves vagal pathways for gut-brain
...
263 Desbonnet L, Garrett L, Clarke G, Bienenstock J, Dinan TG. The probiotic Biﬁ-
...
analysis reveals large effects of gut microﬂora on mammalian blood metabolites.
