# Petrovic_2020_Digital Mental Health Tools for Caregivers of Older Adults-A Scoping Review.
...
Caregivers of Older Adults—A
Scoping Review

Milica Petrovic 1* and Andrea Gaggioli 1,2

1 Department of Psychology, Catholic University of Sacred Heart, Milan, Italy, 2 Applied Technology for Neuro-Psychology
Lab, Istituto Auxologico Italiano (IRCCS), Milan, Italy

Aim: Informal caregivers have an important role in bridging the gap between the
assistance care recipients need and what can be provided by the health care systems
across Europe. The burden of the caregiving role places a signiﬁcant threat to caregiver
...
mental health apps available speciﬁcally for the caregiver of older adults. Furthermore,
...
with a limitation of addressing one aspect of caregiver needs –i.e., speciﬁc coping skills
...
Citation:
Petrovic M and Gaggioli A (2020)
Digital Mental Health Tools for
Caregivers of Older Adults—A
Scoping Review.
Front. Public Health 8:128.
doi: 10.3389/fpubh.2020.00128
...
April 2020 | Volume 8 | Article 128

Petrovic and Gaggioli
...
test and challenges the ﬁscal sustainability of long-term care
...
Informal care has been generally deﬁned as unpaid care
...
and diﬃcult topics related to their health and issues they are
...
of diﬃculties reported by the caregivers and can be generally
divided into physical, psychological and ﬁnancial hardship (6).
...
and insuﬃcient or overwhelmed coping skills (11). Stress,
lead to burnout, which
depression, and burden overall
the caregiver’s life and might
...
staﬀ at ensuring they provide appropriate care in the absence of
...
demands of the role (15). The ﬁnal category of interventions
...
the ﬁeld of eHealth interventions, and often interchangeably. In
...
aspect, behavioral modiﬁcation background, and persuasiveness,
...
to the numerous deﬁnitions and papers
produced up to date, only a few colleagues (17, 18) provided
a structured categorization of eHealth by oﬀering three
diﬀerent categories:
...
• Categorizing eHealth technologies according to their inﬂuence

on the health-care systems.

The eHealth categorization reveals how broad the ﬁeld of eHealth
is and the range of services and inﬂuences it can cover. However,
...
the digital tools—i.e., any technological and digital device used to
...
oﬀer convenient, low-cost alternatives to visiting mental health
...
caregiving roles (20). More speciﬁcally, they spend more time
in their caregiving role, with care recipients experiencing more
variability in symptoms and toxicities from diﬀerent, multi-
...
patient’s health status frequently and in diﬀerent ways than other
...
to provide a combination of speciﬁc skills set, coping skills and
...
important note is that interventions for diﬀerent health problems
...
3 years that contained keywords,

caregivers AND burden,” or

“digital mental health
for
(see Figure 1). Retrieved
interventions AND caregivers”
articles were initially reviewed by the title and the abstract
to ﬁnd potentially relevant papers and exclude irrelevant
ones. Relevant articles,
that contained the keywords and
...
dyads but oﬀering support for the caregivers delivered via
tablet, virtual reality
(c) mobile app, website or platform,
...
We (f)
focused on published peer-reviewed articles only,
in English.

Digital mental health tools were deﬁned as interventions and
educational material provided for informal caregivers via mobile
app, computers, tablets, virtual reality, and a mixture of tools such
...
included caregiver of children or young
...
reviewed to extract details about the study population, sample
...
mental health symptoms relevant
to caregivers. The web-
...
training. The ﬁnal category of other digital mental health tools
...
A total of 1,843 relevant non-duplicate records were identiﬁed.
...
four were excluded during the
data extraction due to the insuﬃcient description of the study
...
report of the results. Out of 16 ﬁnal articles with four RCT,
...
there was a reported signiﬁcant positive impact on decreasing
depressive symptoms of the caregivers and signiﬁcant positive
eﬀect on emotional and social competency. The mobile apps
category includes studies reﬂecting on apps that are designed
for the caregivers speciﬁcally (e.g., iCare, RX Reﬁll, Journal,
...
six studies
focused on web-
In the web-based category,
(8–11, 28, 31). The thematic
...
speciﬁc disorders and training proper skills for speciﬁc disorders
the caregiving role. The web-based digital
necessary for
...
The third category of “other” includes the ﬁnal three studies
exploring digital mental health tools that could not be classiﬁed
as mobile apps or web-based mental health tools (5, 29,
30). The mental health tools in question are virtual reality
intervention,
telephone-delivered intervention for caregiver-
...
health and well-being while fulﬁlling the role of a caregiver.
...
Caregivers (n = 11), case-managers (n
...
Service veterans (n = 118). Mean age:
46 ± 13.5
...
conﬁdent in determining solutions in new
...
Informal caregivers (n = 20). Age range:
39–77
...
conﬁdence and control

Care, RX Reﬁll, Journal, Care4Caregivers, VA
Pain Coach, VA PTSD Coach: Applications
developed speciﬁcally for the study and available
...
iTunes, AppStore, and Google Play were
...
Signiﬁcant improvement in psychological
resilience of some caregivers was reported.
Predictive biomarkers were identiﬁed whose
expression was associated with the greater
beneﬁt from MBSR training
...
There was a signiﬁcant decrease in the levels of
stress and symptoms of depression (p = 0.045)

Núñez-Naveira et al. (25)

Informal caregivers (n = 77), from
...
technological and pedagogical speciﬁcations.
There was a signiﬁcant decrease of depressive
symptoms
...
Phongtankuel et al. (26)

Informal caregivers (n = 80). Mean age:
57± 12
...
months after the trial and signiﬁcant improvement
in depressive symptoms

DarmaLife had signiﬁcant positive effect on
...
TDL signiﬁcantly improved empathy, conﬁdence
in caring and positive interactions between
caregiver and care recipient

Zheng et al. (31)

Study1:Veterans Affairs MC VAMC (n =
...
ﬁt the ﬁrst two categories. It is suggested that each category serves
a diﬀerent purpose.
...
speciﬁcally address adverse mental health symptoms.
...
requires narrowing the search to a speciﬁc mental health issue.
...
creating mobile health apps in the ﬁrst place (35).
...
motivation to care (23). There were no adverse eﬀects of digital
...
caregiving role itself, which beneﬁts care-recipients the most.

The digital

tools available center on speciﬁc limitations
or illnesses such as Dementia or Parkinson’s disease, without
oﬀering the all-encompassing digital mental health tool for
caregivers. Namely, a caregiver of an elderly individual without
speciﬁc limitations or health issues might not beneﬁt from a
...
limitations but not speciﬁc mental health diﬃculty, outside of the
research focus.
...
with the lack of research data and literature exploring the speciﬁc
...
caregiver burden, besides scientiﬁc theoretical background, may
...
explanations regarding the eﬀectiveness and therapeutic design
in existing digital mental health tools addressing adverse
mental health issues caregivers face throughout
their role.
...
faced with similar diﬃculties of the caregiving role, it can be quite

diﬃcult to address numerous negative mental health issues with
just one digital mental health tool. As noted during this review
as well, studies generally focus on speciﬁc limitations or illness
...
adverse mental health eﬀects of the caregiving role speciﬁcally.
...
caregivers experience in diﬀerent stages of their role. In other
...
understanding of the role eﬀect on the caregiver’s life and life
adjustments that took place to accommodate the caregiving role
must be taken into consideration. The eﬀects of the role should
...
patterns related to the adverse mental health eﬀects of the
...
health eﬀects of the caregiving role through skills training and
educational material. The therapeutic background of several
reviewed studies was not clearly deﬁned and it reﬂects the general
...
caregiver is providing care for the recipient that has no speciﬁc
...
to add up to the eﬀorts of other colleagues in ﬁlling in the
...
skills, emotional self-regulation, education, skill-building, and
skill training.

In other words, caregivers beneﬁted and showed improved
well-being, lowered levels of stress and burden and increased
emotional regulation after they were educated about
the
...
The lack of clear guidance about the eﬃcacy of the mental health
...
majority of reviewed studies emphasized the eﬀectiveness and
success of the digital tool without reﬂecting on the therapeutic
background or rationale for using a speciﬁc therapeutic approach
...
available, it cannot provide any deﬁnitive conclusion about the
eﬃcacy of the interventions distributed through digital mental
...
delivering the speciﬁc intervention.
...
made in any papers, therefore it cannot deﬁnitively be concluded
that one digital mental health tool or a speciﬁc type of technology
...
1. Spasova S, Baeten R, Coster S, Ghailani D, Peña-Casas R, Vanhercke
B. Challenges
in Long-Term Care in Europe. A Study of National
Policies. European Social Policy Network (ESPN), Brussels: European
Commission (2018).
...
Skoufalos A, Beck EH, Castillo DJ. An
...
more, or less successful when delivered via diﬀerent digital tools
...
further development should include pilot testing over diﬀerent
platforms and by using diﬀerent tools in order to establish
...
Finally, digital mental health tools,

including web-
based, mobile apps, or virtual reality solutions, have the
potential
to reshape health care due to its ability to be
structured in a therapeutic way, providing interventions
their age
for a wide variety of caregivers
audio,
and
text
aﬀordability,
...
MP wrote the manuscript with support and under
the
supervision of AG. MP wrote the main manuscript while AG
participated in every aspect of it with guidance, additional
paragraphs, and numerous corrections.

FUNDING

This project received funding from European Union’s Horizon
2020 research and innovation programme under the Marie
Sklodowska-Curie grant agreement no. 814072.

conditions. Popul Health Manag. (2017) 20:23–30. doi: 10.1089/pop.201
6.0076

3. Triantaﬁllou J, Naiditch M, Repkova K, Stiehr K, Carretero S, Emilsson T, et
al. Informal Care in the Long-Term Care System-European Overview Paper.
(2010).

4. Van Groenou MIB, De Boer A. Providing informal care in a changing
10.1007/s10433-016-
...
5. Piette JD, Striplin D, Marinec N, Chen J, Aikens JE. A randomized trial
of mobile health support for heart failure patients and their informal
caregivers: impacts on caregiver-reported outcomes. Med Care. (2016) 53:692.
doi: 10.1097/MLR.0000000000000378

6. Riﬃn C, Van Ness PH, Wolﬀ JL, Fried T. Family and other unpaid caregivers
and older adults with and without dementia and disability. J Am Geriatr Soc.
(2017) 65:1821–8. doi: 10.1111/jgs.14910

7. Grossman MR, Zak DK, Zelinski EM. Mobile apps for caregivers of older
adults: quantitative content analysis. JMIR mHealth uHealth. (2018) 6:e162.
doi: 10.2196/mhealth.9345

8. Callan JA, Siegle GJ, Abebe K, Black B, Martire L, Schulz R, et al.
intervention in
(2016) 20:575–82.

Feasibility of a pocket-PC based cognitive control
dementia spousal caregivers. Aging Mental Health.
doi: 10.1080/13607863.2015.1031635

9. Ho L, Bloom PA, Vega JG, Yemul S, Zhao W, Ward L, et al. Biomarkers of
resilience in stress reduction for caregivers of Alzheimer’s patients. Neuromol
Med. (2016) 18:177–89. doi: 10.1007/s12017-016-8388-8

10. Kajiyama B, Fernandez G, Carter EA, Humber MB, Thompson
LW. Helping Hispanic dementia caregivers cope with stress using
technology-based
41:209–16.
doi: 10.1080/07317115.2017.1377797
...
11. Brown EL, Ruggiano N, Roberts L, Hristidis V, Whiteman KL, Castro J, et al.
CareHeroes web and AndroidTM s for dementia caregivers: a feasibility study.
Res Gerontol Nurs. (2016) 9:193–203. doi: 10.3928/19404921-20160229-02
12. Wiet SG. Future of caring for an aging population: trends, technology, and

caregiving. Stud Health Technol Inform. (2005) 118:220–30.

13. Lopez-Hartmann M, Wens J, Verhoeven V, Remmen R. The eﬀects of
interventions for informal caregivers of community-
(2012) 12:e133.

caregiver support
frail elderly: a systematic review.
doi: 10.5334/ijic.845
Jardim C, Pakenham KI. Pilot investigation of the eﬀectiveness of respite
care for carers of an adult with mental illness. Clin Psychol. (2009) 13:87–93.
...
15. Vandepitte S, Putman K, Van Den Noortgate N, Verhaeghe S, Annemans
L. Eﬀectiveness of an in-home respite care program to support informal
dementia caregivers: a comparative study. Int J Geriatr Psychiatry. (2019)
34:1534–44. doi: 10.1002/gps.5164

16. Cassie KM, Sanders S, Cummings SM, Kropf NP. Familial caregivers of
older adults. In: Cummings SM, Kropf NP, editors. Handbook of Psychosocial
Interventions With Older Adults: Evidence-Based Approaches. Philadelphia,
PA: The Haworth Press; Routledge (2008). p. 293–320

17. van Gemert-Pijnen LJ, Kip H, Kelders SM, Sanderman R. Introducing eHealth.
eHealth Research, Theory and Development. London: Routledge (2018). p. 3–
26.

18. Van Gemert-Pijnen JEWC, Peters O, Ossebaard HC, editors. Improving

ehealth. The Hague: Eleven International Publishing (2013).

19. Christie H, Martin J, Connor J, Hermans I, Tange HJ, Verhey FR,
et al. Which eHealth interventions for caregivers of people with dementia
are used in practice? Examining development trajectories and business
models Alzheimer’s and Dementia. J Alzheimer’s Assoc. (2019) 15:P511.
doi: 10.1016/j.jalz.2019.06.1217
20. Northouse LL, Katapodi MC,

Schafenacker AM, Weiss D. The
impact of
family
caregivers and cancer patients. Semin Oncol Nurs. (2012) 28:236–245.
doi: 10.1016/j.soncn.2012.09.006

caregiving on the psychological well-being of

21. Kent EE, Rowland JH, Northouse L, Litzelman K, Chou WYS, Shelburne
N, et al. Caring for caregivers and patients:
research and clinical
priorities for informal cancer caregiving. Cancer. (2016) 122:1987–95.
doi: 10.1002/cncr.29939

22. Bush NE, Smolenski DJ, Denneson LM, Williams HB, Thomas EK, Dobscha
SK. A virtual hope box: a randomized controlled trial of a smartphone
for emotional regulation and coping with distress. Psychiatr Serv. (2016)
68:330–6. doi: 10.1176/appi.ps.201600283

23. Crookston BT, West JH, Hall PC, Dahle KM, Heaton TL, Beck RN, et al.
Mental and emotional self-help technology apps: cross-sectional study of
theory, technology, and mental health behaviors. JMIR Mental Health. (2017)
4:e45. doi: 10.2196/mental.7262

24. Frisbee KL. Variations in the use of mHealth tools: the VA Mobile Health
Study. JMIR mHealth uHealth. (2016) 4:e89. doi: 10.2196/mhealth.3726
25. Núñez-Naveira L, Alonso-Búa B, de Labra C, Gregersen R, Maibom K, Mojs
E, et al. UnderstAID, an ICT platform to help informal caregivers of people
with dementia: a pilot randomized controlled study. Biomed Res Int. (2016)
2016:5726465. doi: 10.1155/2016/5726465

26. Phongtankuel V, Shalev A, Adelman RD, Dewald R, Dignam R, Baughn
R, et al. Mobile Health technology is here—but are hospice informal
caregivers
(2018) 35:1547–52.
doi: 10.1177/1049909118779018

receptive? Am J Hospice Palliat Med.

27. Poonamallee L, Harrington AM, Nagpal M, Musial A. Improving emotional
intelligence through personality development: the eﬀect of the smart-phone
application based Dharma Life Program on emotional intelligence. Front
Psychol. (2018) 9:169. doi: 10.3389/fpsyg.2018.00169

28. Tam JW, Schmitter-Edgecombe M. A caregiver educational program: a video
program to promote aging services technologies awareness. Geriatr Nurs.
(2019) 40:78–83. doi: 10.1016/j.gerinurse.2018.06.015

29. Tremont G, Davis JD, Ott BR, Galioto R, Crook C, Papandonatos GD, et al.
Randomized trial of the family intervention: telephone tracking—caregiver
for dementia caregivers: use of community and healthcare resources. J Am
Geriatr Soc. (2017) 65:924–30. doi: 10.1111/jgs.14684

30. Wijma EM, Veerbeek MA, Prins M, Pot AM, Willemse BM. A virtual
reality intervention to improve the understanding and empathy for
people with dementia in informal caregivers: results of a pilot study.
Aging Mental Health. (2018) 22:1121–9. doi: 10.1080/13607863.2017.13
48470

31. Zheng R, Hicken BL, Hill RD, Luptak M, Daniel CM, Grant M,
et al. Digital
training for older persons:
cognitive and aﬀective perspectives. Educ Gerontol. (2016) 42:540–50.
doi: 10.1080/03601277.2016.1161989

technology and caregiver

32. LeBeau K, Huey LG, Hart M. Assessing the quality of mobile apps
used by occupational therapists: evaluation using the user version of the
mobile application rating scale. JMIR mHealth uHealth. (2019) 7:e13019.
doi: 10.2196/13019
...
34. Boudreaux ED, Waring ME, Hayes RB,
...
35. Stoyanov SR, Hides L, Kavanagh DJ, Zelenko O, Tjondronegoro D, Mani
M. Mobile app rating scale: a new tool for assessing the quality of health
mobile apps. JMIR mHealth uHealth. (2015) 3:e27. doi: 10.2196/mhealth.
3422
...
Copyright © 2020 Petrovic and Gaggioli. This is an open-access article distributed
