...
**Source:** WEBMD
**URL:** https://www.webmd.com/mental-health/dissociative-identity-disorder-multiple-personality-disorder
...
Dissociative identity disorder (DID), previously known as multiple personality disorder, is a complex psychological condition caused by many things. These include severe trauma during early childhood (usually extreme, repetitive physical, sexual, or emotional abuse). It's also known as split personality disorder.Â

With DID, you have separate identities. (Photo Credit: Moment / Getty Images)

DID is a severe form ofdissociation, a mental process that produces a lack of connection in your thoughts, memories, feelings, actions, or sense of identity. The dissociative aspect is thought to be a coping mechanism -- you literally shut off or dissociate yourself from a situation or experience that's too violent, traumatic, or painful to assimilate with your conscious self.

When you have DID, you have two or more separate identities called âalters.â They control your behavior at various times. Each alter has its own personal history, traits, likes, and dislikes.

## Types of Dissociative Disorders

DID is one of three types of dissociative disorders. The others are:Â

Dissociative amnesia.This happens when you canât remember essential information about your life. This may be limited to specific areas of your life or it may include your life history and identity.

Three types ofamnesiaassociated with DID are:

- Localized: This is the most common type of amnesia. You canât remember an event or period of time.

- Selective: This is where you canât remember details of events within a certain time frame.

- Generalized: This is the least common type. You canât remember anything about your identity and life history.
...
Not everyone with DID experiences it the same way. For some, their "alters" Â have their own age, sex, or race -- plus their own postures, gestures, and distinct ways of talking. Sometimes the alters are imaginary people; sometimes they're animals.Â

As each "alter" or personality reveals itself and controls your behavior and thoughts, it's called "switching." Switching can take seconds, minutes, or days. You might seek treatment withÂ hypnosis, where your different "alters" may be responsive to your therapist's requests.

Other symptoms of DID can includeÂheadache, amnesia, time loss, trances, and "out of body experiences." Some people with dissociative disorders have a tendency toward self-persecution and self-sabotage, and have a higher risk of death by suicide..Â

If you have DID, you may find yourself doing things you wouldn't normally do, such as speeding, reckless driving, or stealing money from your employer or friend. But you feel compelled to do these things.Â
...
- You feel detached from your body. It's often referred to as an "out-of-body" experience. This is calleddepersonalization.Â

- You feel that the world isn't real, or it looks foggy or far away. This is called derealization.Â
...
- You have a sense of confusion about who you are. This is called identity confusion or identity alteration. An example of identity confusion is when you have trouble defining the things that interest you in life, your political or religious or social viewpoints, yourÂ sexual orientation, or your professional ambitions. In addition, you may experience distortions in time, place, and situation.
...
- The symptoms cannot be due to the direct physiological effects of a substance (such as blackouts or chaotic behavior during alcohol intoxication) or a general medical condition (such as complexÂpartial seizures).
...
There are no formal, evidence-based guidelines to treat DID.Â Many treatments are based on case reports or are controversial.Â Â
...
Psychotherapy:Also called talk therapy, this is designed to help you work through your DID triggers. The goal is to help âfuseâ your separate personality traits into one consolidated personality who can control your triggers. This therapy often includesÂ participation of your family members.

- Cognitive behavioral therapy (CBT).This is a structured, goal-oriented type ofpsychotherapy. CBT helps you unlearn negative thoughts and behaviors and adopt healthier thinking patterns and habits.

- Dialecticalbehavior therapy(DBT).This works well if youexperience emotions intensely. The goal is a balance between validation (acceptance) of who you are, your challenges, and the benefits of change. Your therapist will help you learn skills for emotion regulation.
...
There are no establishedÂ medicationÂ treatments for dissociative identity disorder, making psychologically-based approaches the mainstay of therapy. Treatment of co-occurring disorders, such asÂ depressionÂ or substance use disorders, is fundamental to overall improvement. Because the symptoms of dissociative disorders often occur with other disorders, such as anxiety andÂ depression, medicines to treat those co-occurring problems are sometimes used in addition to psychotherapy.

Therapy can be difficult and painful, but it can significantly help your symptoms in the long term.

Can DID Be Cured?

There's no cure for DID. You have to manage it for the rest of yourlife. But treatments can reduce your symptoms and help you function better at work, home, and your community.
...
- There's no cure for DID, but treatment is available.Â

- With treatment, it's possible to manage DID and live a normal life.Â

Can you live a good life with DID?

Yes. It's possible to live a normal life with DID if you get treatment from trainedmental health specialists.Â

How do I know if I am dissociating?

The symptoms aren't the same for everyone. But you might feeldisconnected from yourself and the world around you; forgetabout periods of time, events, and personal information; or feel unsure about who you are.

What are three key features of dissociative identity disorder?

- The existence of two or more distinct identitiesÂ

- Permanent lapses in your memory about everyday and traumatic events, as well as your personal informationÂ
...
Cleveland Clinic: "Dissociative Disorders," "Dissociative Identity Disorder."

American Psychiatric Association: "What Are Dissociative Disorders?"Â
