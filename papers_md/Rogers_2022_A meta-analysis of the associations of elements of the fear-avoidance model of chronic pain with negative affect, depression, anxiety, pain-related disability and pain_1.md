# Rogers_2022_A meta-analysis of the associations of elements of the fear-avoidance model of chronic pain with negative affect, depression, anxiety, pain-related disability and pain_1
...
A meta- analysis of the associations of elements of the 
fear- avoidance model of chronic pain with negative affect, 
depression, anxiety, pain- related disability and pain 
intensity
...
2Department of Psychology, Rutgers, 
The State University of New Jersey, 
Piscataway, New Jersey, USA

Correspondence
Samantha G. Farris, Department of 
Psychology, The State University of 
...
conditions  recognize  the  multi- faceted  nature  of  pain  experience  and  its  inter-

section  with  mental  health.  A  primary  cognitive- behavioural  framework  is  the 

Fear- Avoidance Model, which posits that pain catastrophizing and fear of pain 

(including  avoidance,  cognitions  and  physiological  reactivity)  are  key  anteced-

ents to, and drivers of, pain intensity and disability, in addition to pain- related 

psychological  distress.  This  study  aimed  to  provide  a  comprehensive  analysis 

of  the  magnitude  of  the  cross- sectional  association  between  the  primary  com-
...
medium to large associations with pain-  related negative affect, anxiety, and de-
...
non- cancer pain (Schütze et al., 2018). Further meta- analytic 
...
et al., 2011). Heightened emotional distress is associated 
with  more  severe  pain  intensity  (Gaskin  et  al.,  1992; 
Wiech & Tracey, 2009; Wong et al., 2015) and can lead to 

ROGERS and FARRIS 
 
more severe and debilitating pain (Linton & Shaw, 2011; 
...
ondary  emotions  to  the  experience  of  fear  (Rodríguez- 
...
Ramírez- Maestre, 2013), and, given the differences that 
...
(Ocañez  et  al.,  2010),  including:  pain  intensity,  pain- 
...
|  Pain catastrophizing, fear of pain and 
...
(FABQ),  Fear- Avoidance  of  Pain  Scale  (FAPS),  Fear 
...
Ocañez et al., 2010; Zale et al., 2013). Outcome measures 
...
homogeneity  assumption  for  meta- analyses,  I2  and  τ2  were 
examined.  Based  on  past  research  I2  can  be  quantified  as 
...
nificant  heterogeneity  estimates  (I2  = 86.5%,  τ
2  = 0.02, 
...
not statistically powered. Differences by measure type were 
not examined due to the lack of heterogeneity.

3.1.2 

|  Anxiety

A total of 74 studies (50 aggregated effect sizes) were included, 
accounting for n = 9470 participants. Random- effects meta- 
analyses  estimated  the  pooled  correlation  of  0.50  (95%  CI 
[0.46, 0.54]) for the relationship between pain catastrophizing 
and  anxiety,  with  high  heterogeneity  estimates  (I2  = 80.3%, 
2 = 0.03, p < 0.001). Egger's test for funnel plot asymmetry as 
τ
well as an examination of the contoured funnel plot indicate 
no small study bias (z = −0.24, p = 0.76).

3.1.3 

|  Depression

A  total  of  139  studies  (87  aggregated  effect  sizes)  exam-
ined  the  relationship  between  pain  catastrophizing  and 
depression,  totalling  n  =  17,623  participants.  Random- 
effect  meta- analyses  estimated  the  pooled  correlation  to 
be 0.51 (95% CI [0.48, 0.54]), with high heterogeneity es-
timates (I2 = 79.4%, τ
2 = 0.03, p < 0.001). Egger's test for 
funnel plot asymmetry as well as examination of the con-
toured funnel plot indicate no small study bias (z = −0.55, 
p = 0.32).
...
A  total  of  308  studies  (152  aggregated  effect  sizes)  were 
included,  totalling  a  sample  size  of  n  =  28,875  individu-
als.  Random- effects  meta- analysis  indicated  a  pooled 
correlation  of  0.38  (95%  CI  [0.35,  0.31]).  Heterogeneity 
estimates  for  the  study  were  high  (I2  = 83.7%, τ
2  = 0.03), 
with  significance  tests  suggesting  significant  heterogene-
ity (p < 0.001). Examination of the contoured funnel plot 
and  Egger's  test  for  funnel  plot  asymmetry  revealed  evi-
dence for small study bias (z = 1.82, p < 0.001). The trim 
and  fill  procedure  indicated  that  49  studies  would  need 
to be imputed to the left of the mean, corresponding to a 
weaker correlation between pain catastrophizing and pain 
intensity, to eliminate small study bias. Following the im-
putation  procedure,  the  corrected  pooled  random  effects 
correlation for pain catastrophizing and pain intensity is 
...
A  total  of  159  studies  (98  aggregated  effect  sizes)  were 
included in the meta- analysis, accounting for n = 22,332 
...
T A B L E   2  Fear of pain moderator results
...
heterogeneity estimates (I2 = 80.4%, τ
2 = 0.02, p < 0.001). 
...
with non- significant heterogeneity estimates (I2 = 41.4%, 
2  = 0.01,  p  =  0.15).  Given  the  small  number  of  studies 
τ
...
(I2 = 79.9%, τ
2 = 0.03, p < 0.001). Egger's test for funnel plot 
...
(I2 = 67.1%, τ
2 = 0.02, p < 0.001). Egger's test for funnel plot 
...
for  the  study  were  high  (I2  = 78.1%,  τ
2  = 0.02),  with  sig-
nificance 
tests  suggesting  significant  heterogeneity 
...
heterogeneity estimates (I2 = 76.5%, τ
2 = 0.02, p < 0.001). 
...
(I2 = 89.9%, τ
2 = 0.05, p < 0.001). However, given the small 
...
mates for the study were high (I2 = 85.5%, τ
2 = 0.04), with 
...
heterogeneity estimates (I2 = 63.3%, τ
2 = 0.02, p = 0.005). 
...
|  Moderator analyses— measure type
...
(except pain intensity— small association), with minimal 
...
associated  with  pain  and  function  outcomes  (Ljótsson 
...
number of different circumstances (McNeil et al., 2018), 
...
and extend past findings, and have important clinical impli-
...
Esteve, R., & Ramírez- Maestre, C. (2013). Pain fear avoidance and 
...
Ljótsson,  B.,  Hesser,  H.,  Andersson,  E.,  Lindfors,  P.,  Hursti,  T., 
Rück, C., Lindefors, N., Andersson, G., & Hedman, E. (2013). 
...
Ocañez,  K.  L.  S.,  McHugh,  R.  K.,  &  Otto,  M.  W.  (2010).  A  meta- 
...
Rodríguez- Torres, R., Leyens, J.P., Pérez, A.R., Rodriguez, V.B., Castillo, 
...
Schemer, L., Schroeder, A., Ørnbøl, E., & Glombiewski, J. A. (2019). 
...
Swinkels- Meewisse, I. E. J., Roelofs, J., Oostendorp, R. A. B., Verbeek, 
